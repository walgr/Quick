 ...
 *
 */
class TestNormalCallAdapterFactory private constructor(): CallAdapter.Factory() {

    companion object {
        fun create() = TestNormalCallAdapterFactory()
    }
    ...
    override fun get(
        ...
        if (rawType == TestNormalCall::class.java) {
            ...
            return TestNormalCallAdapter(sResponseType, sResponseClz, baseResponseF)
        }
        return null
    }
}